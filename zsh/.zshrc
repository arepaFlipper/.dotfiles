...
alias ecommerce="tmoxpen ecommerce"
alias iomobile="tmoxpen iomobile"
alias quiz_craft="tmoxpen quiz_craft"
alias rust_tuto="tmoxpen rust_tuto"
alias chatapp="tmoxpen chatapp"
alias microservices="tmoxpen microservices"
alias portfolio="tmoxpen portfolio"
alias docker_tuto="tmoxpen docker_tuto"
alias git_tuto="tmoxpen git_tuto"
alias leetcode="tmoxpen leetcode"
alias bot="tmoxpen bot"
alias recycle="tmoxpen recycle"
alias keyboard="tmoxpen keyboard"
alias litetech="tmoxpen litetech"
alias onlyfans="tmoxpen onlyfans"
alias debt="tmoxpen debt"
alias fit="tmoxpen fit"
alias pop="tmoxpen pop"
...
# zoxide must be initialized last so its chpwd hook isn't clobbered by later
# config (see `zoxide doctor`). On macOS home-manager inits zoxide after this
# file is sourced, so only init here on non-darwin systems to avoid a duplicate.
if [[ "$OSTYPE" != darwin* ]]; then
